...
{
    public class FormaGeometrica_DEPRECATED
    {
        #region Formas
        ...
        public FormaGeometrica_DEPRECATED(int tipo, decimal ancho)
        {
            Tipo = tipo;
            _lado = ancho;
        }

        public static string Imprimir(List<FormaGeometrica_DEPRECATED> formas, int idioma)
        {
